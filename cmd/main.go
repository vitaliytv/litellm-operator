...
func main() {
	...
	litellmInstanceReconciler := litellm.NewLiteLLMInstanceReconciler(mgr.GetClient(), mgr.GetScheme())
	if err = litellmInstanceReconciler.SetupWithManager(mgr); err != nil {
